...
ActiveRecord::Schema.define(version: 20160226185800) do
  ...
  add_index "workout_tags", ["tag_id"], name: "index_workout_tags_on_tag_id", using: :btree
  add_index "workout_tags", ["workout_id"], name: "index_workout_tags_on_workout_id", using: :btree
